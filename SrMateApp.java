...
public class SrMateApp extends JFrame {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/srmatedb?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
private static final String DB_USER = "root";
private static final String DB_PASS = "CodeRoot@07";
    ...
    private JPanel createProfileScreen() {
        ...
        JLabel imageLabel = new JLabel("USER", SwingConstants.CENTER);
        ...
        JButton rejectBtn = createRoundButton("X", new Color(255, 100, 100));
        rejectBtn.setPreferredSize(new Dimension(80, 80));
        rejectBtn.addActionListener(e -> handleSwipe("REJECT"));
        
        JButton likeBtn = createRoundButton("♥", new Color(100, 255, 100));
    ...
    private JPanel createMatchCard(int userId, String name, int age, String college, 
        ...
        JLabel iconLabel = new JLabel("USER", SwingConstants.CENTER);
